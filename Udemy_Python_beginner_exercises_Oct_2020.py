...
one which will hold a randomly generated integer between 10 and 25 (inclusive of both 10 and 25),
...
randomGallon = (randint(10, 26))
randomMiles = (randint(200, 401))
MPG = randomMiles / randomGallon
print(MPG)
